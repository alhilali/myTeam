...
TabsPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["a" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__tabs__["a" /* TabsPage */])
        ]
    })
], TabsPageModule);
...
TabsPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_6" /* Component */])({template:/*ion-inline-start:"/Users/saudalhilali/Desktop/startUp/myTeam/src/pages/tabs/tabs.html"*/'<ion-tabs tabsLayout="title-hide">\n  <ion-tab [root]="tab1Root" tabTitle="الرئيسية" tabIcon="home" #content swipeBackEnabled="true"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="فريقي" tabIcon="football" #content swipeBackEnabled="true"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="تنبيهات" tabBadge="{{notificationNum}}" tabBadgeStyle="danger" tabIcon="ios-notifications-outline" #content swipeBackEnabled="true"></ion-tab>\n  <ion-tab [root]="tab4Root" tabTitle="بحث" tabIcon="search" #content swipeBackEnabled="true"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/saudalhilali/Desktop/startUp/myTeam/src/pages/tabs/tabs.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* Events */], __WEBPACK_IMPORTED_MODULE_2_angularfire2_database__["b" /* AngularFireDatabase */],
