...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_player__ = __webpack_require__(1163);
...
var AddPlayerPage = (function () {
    function AddPlayerPage(view, navCtrl, navParams, db, teamDB, _form, unameValid) {
        ...
        this.requestPlayerForm = _form.group({
            "username": ['',
                __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].required,
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].pattern('^[a-zA-Z0-9_.-]*$')]),
                __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].composeAsync([usernameValidator, teamValidator])]
        });
    }
