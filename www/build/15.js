...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__player__ = __webpack_require__(1193);
    ...
    PlayerPage.prototype.ionViewDidLoad = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.navParams.get('username')) return [3 /*break*/, 1];
                        this.playerUID = this.navParams.get('id');
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.teamDB.findUID(this.navParams.get('username')).then(function (data) {
