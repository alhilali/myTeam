...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login__ = __webpack_require__(1168);
...
var LoginPage = (function () {
    function LoginPage(afAuth, loadingCtrl, toast, alertCtrl, navCtrl, navParams, myTeamDB, _form) {
        ...
        this.loginForm = this._form.group({
            "email": ["", __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].email],
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.myTeamDB.findEmail(user.email).then(function (data) {
                            _this.afAuth.auth.signInWithEmailAndPassword(data, user.password)
                                .catch(function (err) {
...
LoginPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_angularfire2_auth__["b" /* AngularFireAuth */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* LoadingController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* AlertController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_3__helpers_myTeamDB__["a" /* MyTeamDB */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* FormBuilder */]])
], LoginPage);
