...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__register__ = __webpack_require__(1174);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__validators_username__ = __webpack_require__(677);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegisterPage = (function () {
    function RegisterPage(afAuth, toast, navCtrl, navParams, db, _form, unameValid, mdlController) {
        this.afAuth = afAuth;
        this.toast = toast;
        ...
        this.registerForm = this._form.group({
            "name": ["", __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].maxLength(30), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].pattern('[a-zA-Z-ء-ي_ ]*'), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].required])],
            "username": ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].pattern('^[a-zA-Z0-9_.-]*$')]), usernameValidator],
            "email": ["", __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].email],
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (e_1.code == 'auth/email-already-in-use')
                            this.usedEmail = true;
                        setTimeout(function () { _this.usedEmail = false; }, 2000);
                        return [3 /*break*/, 4];
